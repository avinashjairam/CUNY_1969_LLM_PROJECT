...
class DemoRunner:
    ...
    def setup_demo(self):
        self.print_header("CUNY 1969 Historical Chatbot Demo")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='CUNY 1969 Chatbot Demo Runner')
